...
Minha trajetória começou na **robótica competitiva**, onde desenvolvi sistemas de decisão em tempo real para robôs autônomos. Hoje aplico essa mesma lógica analítica para **extrair insights de dados, construir modelos e resolver problemas complexos com programação**.
...
# 🏆 Da Robótica Competitiva para a Análise de Dados
...
<br>
<em>Campeão Nacional da Olimpíada Brasileira de Robótica (OBR) - 2024</em>
</p>
